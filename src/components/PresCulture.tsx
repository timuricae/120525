...
export default function PresCultureSingle() {
    ...
    return (
        <div style={{ padding: 20, maxWidth: 1000, margin: "0 auto" }}>
            ...
            <section style={{ marginBottom: 30, maxWidth: 1000 }}>
                <h2>Проект "Сохранённая культура"</h2>
                <p>
                    Добро пожаловать в интерактивный модуль, посвящённый российскому частному проекту "Сохраненная культура". Рекомендуем ознакомиться с основными
                    материалами, представленными на официальном сайте проекта{" "}
                    <a href="https://prescult.ru/" target="_blank" rel="noopener noreferrer">
                        PresCult.ru
                    </a>{" "}
                    ...
                    . Эти ресурсы помогут вам получить общее представление о предметной области.
                </p>
                <p>
                    В данном упражнении вам предстоит распределить ключевые понятия по соответствующим
                    тематическим разделам: <em>Цели</em>, <em>Задачи</em>, <em>Партнёры</em>, <em>Персоны</em> и <em>Проекты</em>.
                    Для этого перетащите карточки с понятиями из блока &laquo;Понятия&raquo; в нужные категории.
                    После завершения размещения нажмите кнопку &laquo;Проверить ответы&raquo;, чтобы оценить правильность
                    распределения. Обратите внимание, что вы можете изменить своё решение до проверки.
                </p>
                <p>
                    Также на оцифиальном сайте представлен блок <strong>«Персоны»</strong>, где вы сможете ознакомиться с деятелями культуры
                    в России — учёными, художниками, архитекторами и другими интеллектуалами, чьи достижения и наследие
                    проект стремится сохранить и сделать доступными.
                </p>
            </section>
